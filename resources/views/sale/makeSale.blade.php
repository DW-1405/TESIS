                ...
                <form action="{{route('sale.store')}}" method="POST">
                    ...
                    <div class="row ">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="d-flex flex-wrap align-content-center"
                                    for="voucher"><strong>{{__('Tipo de comprobante')}}</strong></label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="d-flex flex-wrap align-content-center"
                                    for="clients"><strong>{{__('Cliente')}}</strong></label>
                    ...
                    <div class="row">
                        ...
                        <div class="ml-3 col-md-5 d-none alert alert-danger" role="alert" id="error-exists"><strong>Este producto ya está agregado</strong></div>
                        <div class="col-md-12">
                            <div class="ml-3 col-md-5 d-none alert alert-danger" role="alert" id="error-stock">
                                <strong>Productos insuficientes</strong></div>
                            <div class="col-md-12">
                            ...
                            <div class="tile-footer">
                                ...
                                <a href="{{route('sale')}}" class="btn btn-danger">Volver</a>
                            </div>
                        </div>
                </form>
            </div>
