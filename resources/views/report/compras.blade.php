                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered" id="sampleTable">
                        ...
                        <tbody class="text-center">
                                ...
                                <tr>                                        
                                    <td>{{$compra->id}}</td>
                                    <td>{{\Carbon\Carbon::parse($compra->date)->format('d M y h:i a')}}</td>
                                    <td class="text-center">
                                        <a href="{{route('printer', $compra)}}" class="text-inverse p-r-10" data-toggle="tooltip" title="Imprimir"><i class="fa fa-print"></i></a>
                                    </td>
                                </tr>
                                @endforeach     
                        </tbody>
    ...
    <div class="col-md-3 col-lg-3 col-sm-5">
        <div class="white-box">
	        <div class="text-center">
		        <span>CONSULTA DE COMPRAS <b> </b></span>
